    ...
    <div class="lg:pl-64 flex flex-col">
        ...
        <div class="flex-1 flex justify-between px-4 sm:px-6 lg:px-8">
          ...
          <div class="flex items-center">
            ...
            <Menu as="div" class="ml-3 relative">
              ...
              <button
                class="border-x font-sans font-bold text-gray-700 shadow-lg hover:bg-gray-500 outline-none active:outline-none focus:outline-none"
              >
                Signup
              </button>
              <button
                class="border-x font-sans font-bold text-gray-700 px-3 shadow-lg hover:bg-gray-500 outline-none active:outline-none focus:outline-none"
              >
                Signin
              </button>
            </Menu>
      ...
      <main class="flex-1">
        ...
        >
          ...
          <div class="mt-4 flex sm:mt-0 sm:ml-4">
            <div class="okrModal">
              <button
                type="button"
                class="order-0 inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-purple-600 hover:bg-purple-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 sm:order-1 sm:ml-3"
                  ...
                  <div class="flex flex-col w-full bg-white rounded shadow-2xl">
                    <div>
                      ...
                      <div class="mt-1">
                        <input
                          v-model="newOkr"
                          class="mx-1 my-1 border-x border-y focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md"
                        />
                      </div>
                    </div>
                    <button
                      class="px-6 py-2 m-auto mt-1 mb-3 text-white bg-green-500 rounded w-/3"
                      @click="toggleModal = false"
                    >
                      Save
                    </button>
                    <button
                      class="px-6 py-2 m-auto mt-1 mb-3 text-white bg-green-500 rounded w-3/3"
                      @click="toggleModal = false"
                    >
                      Close
                    </button>
        ...
        <div class="mt-10 sm:hidden">
          ...
          >
            <li v-for="okr in okrs" :key="okr.id">
              <a
                href="#"
